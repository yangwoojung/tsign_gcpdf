...
public final class AlwaysListTypeAdapterFactory<E> implements TypeAdapterFactory {
	...
	public <T> TypeAdapter<T> create(final Gson gson, final TypeToken<T> typeToken) {
		// If it's not a List -- just delegate the job to Gson and let it pick the best
		// type adapter itself
		...
		// Note that the always-list type adapter is made null-safe, so we don't have to
		// check nulls ourselves
		@SuppressWarnings("unchecked")
