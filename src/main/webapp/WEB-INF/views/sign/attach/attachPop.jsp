            ...
            <c:forEach items="${docList}" var="doc" varStatus="status">
                <li class="list parent" data-no="${status.count}" data-cd="${doc.docCd}" data-subReq="${doc.subReq}"
                    ...
                    <div class="front">
                        ...
                        <ul class="file">
                            <li class="btn_file">
                                <input type="file" name="uploadfile" class="btn_file_up"
                                       accept="image/jpg, image/jpeg"/>
                            </li>
                            <li class="btn_camera">
                                <input type="file" name="uploadfile" class="btn_file_up" accept="image/*"
                                       capture="capture"/>
                            </li>
                        </ul>
                        <input type="hidden" name="uploadbinary" class="uploadbinary parent" data-cd="${doc.docCd}"
                               data-subReq="${doc.subReq}"/>
                        <!-- //file -->
                    </div>
                    <!-- //front -->
                    ...
                    <div class="form_box bg" data-doc-num="1">
                        <dl class="list">
                            <dt>발급번호</dt>
                            <dd>
                                <input type="text" class="input_ty" placeholder="-없이 입력" onkeyup="removeSymbol(this)"
                                       name="cerCvaIsnNo"/>
                            </dd>
                        </dl>
                        ...
                        <dl class="list">
                            <dt>발급일</dt>
                            <dd>
                                <input type="text" class="input_ty" placeholder="8자리 숫자로 입력 (예 : 20200324)"
                                       maxlength="8"
                        ...
                        <div class="li_on" data-name="form_box_btn_li">
                            <div class="btn_area">
                                <p class="btn01">
                                    <button class="btn_m btn_ty02" data-name="form_box_submit">확인하기</button>
                                </p>
                                <p class="btn02">
                                    <button class="btn_m btn_ty03" data-name="form_box_reset">다시입력</button>
                                </p>
                            </div>
                    ...
                    <div class="form_box bg" data-doc-num="4">
                        ...
                        <dl class="list">
                            <dt>발급확인번호</dt>
                            <dd class="registered">
                                <p><input type="text" class="input_ty" placeholder="4자리" maxlength="4" name="issueNo1">
                                </p>
                                <p><input type="text" class="input_ty" placeholder="4자리" maxlength="4" name="issueNo2">
                                </p>
                                <p><input type="text" class="input_ty" placeholder="4자리" maxlength="4" name="issueNo3">
                                </p>
                            </dd>
                        </dl>
                        <div class="li_on" data-name="form_box_btn_li">
                    ...
                    <div class="form_box bg" data-doc-num="5">
                        <dl class="list">
                            <dt>인감제출자</dt>
                            <dd><input type="text" class="input_ty" placeholder="공백 포함 입력 (예 :대표이사 홍길동)"
                                       name="submitter"></dd>
                        </dl>
                        <dl class="list">
                            <dt>주민번호</dt>
                        ...
                        <dl class="list">
                            <dt>발급일</dt>
                            <dd><input type="text" class="input_ty" placeholder="발급일자 (예 : 20200306)" maxlength="8"
                                       name="yyyymmdd"></dd>
                        </dl>
                        <dl class="list">
                            <dt>발급확인번호</dt>
                    ...
                    <div class="form_box bg" data-doc-num="6">
                        ...
                        <dl class="list">
                            <dt>발급확인번호</dt>
                            <dd class="registered">
                                <input type="text" class="input_ty" placeholder="-없이 숫자만 입력" maxlength="20"
                                       name="reqNo1">
                            </dd>
                        </dl>
                        <div class="li_on" data-name="form_box_btn_li">
...
<div class="layer_pop slideUp" id="cautionPop" style="display:none;">
    <div class="bg"></div>
    <div class="layer">
        <div class="pop_top">
            <h2>촬영 시 유의사항</h2>
        ...
        <div class="pop_cont t_l">
            <div class="mb02">
                <span class="t_color">여백은 최소화</span> 해주시고, <span class="t_color">원본이 잘리거나, 흐릿하게 촬영된 경우</span>에는 <span
                    class="t_color">반드시 다시 촬영</span>해 주세요.
            </div>
            <div class="mb02">
                <h3 class="t_tit mb01">1. 신분증 촬영 예시</h3>
                <div class="photo_caution">
                    <p class="text01">여백 최소화</p>
                    <img src="/resources/sign/images/data/img_caution_ex01.jpg" style="width:100%; max-width:220px"
                         alt="">
                </div>
            </div>
            <div class="mb02">
                ...
                <div class="photo_caution">
                    ...
                    <img src="/resources/sign/images/data/img_caution_ex02.jpg" style="width:100%; max-width:90px"
                         alt="">
                </div>
            </div>
            <div class="mt01">
...
<div class="layer_pop" id="loadingScrPop" style="display:none;">
    ...
    <div class="layer">
        ...
        <div class="pop_cont">
            <p class="loading"><img src="/resources/sign/images/layout/loading.gif" style="width:100%" alt="loading">
            </p>
            <p class="text mt02">
                진위여부를 확인하고 있습니다.<br/>
                절대 화면을 닫으시면 안됩니다.<br/>
...
<script type="text/javascript">
    ...
    var fnSelSidoChangeAction = function () {
        ...
        switch (sido) {
            case '01' :
                sigunguArr = ["종로구", "중구", "용산구", "성동구", "광진구", "동대문구", "중랑구", "성북구", "강북구", "도봉구", "노원구", "은평구", "서대문구", "마포구", "양천구", "강서구", "구로구", "금천구", "영등포구", "동작구", "관악구", "서초구", "강남구", "송파구", "강동구"];
                break;
            case '02' :
                sigunguArr = ["중구", "서구", "동구", "영도구", "부산진구", "동래구", "남구", "북구", "해운대구", "사하구", "금정구", "강서구", "연제구", "수영구", "사상구", "기장군"];
                break;
            case '03' :
                sigunguArr = ["중구", "동구", "서구", "남구", "북구", "수성구", "달서구", "달성군"];
                break;
            case '04' :
                sigunguArr = ["중구", "동구", "미추홀구", "연수구", "남동구", "부평구", "계양구", "서구", "강화군", "옹진군"];
                break;
            case '05' :
                sigunguArr = ["동구", "서구", "남구", "북구", "광산구"];
                break;
            case '06' :
                sigunguArr = ["동구", "중구", "서구", "유성구", "대덕구"];
                break;
            case '07' :
                sigunguArr = ["중구", "남구", "동구", "북구", "울주군"];
                break;
            case '08' :
                sigunguArr = ["수원시", "성남시", "의정부시", "안양시", "부천시", "광명시", "평택시", "동두천시", "안산시", "고양시", "과천시", "구리시", "남양주시", "오산시", "시흥시", "군포시", "의왕시", "하남시", "용인시", "파주시", "이천시", "안성시", "김포시", "연천군", "가평군", "양평군", "화성시", "광주시", "양주시", "포천시", "여주시"];
                break;
            case '09' :
                sigunguArr = ["춘천시", "원주시", "강릉시", "동해시", "태백시", "속초시", "삼척시", "홍천군", "횡성군", "영월군", "평창군", "정선군", "철원군", "화천군", "양구군", "인제군", "고성군", "양양군"];
                break;
            case '10' :
                sigunguArr = ["충주시", "제천시", "보은군", "옥천군", "영동군", "진천군", "괴산군", "음성군", "단양군", "증평군", "청주시"];
                break;
            case '11' :
                sigunguArr = ["천안시", "공주시", "보령시", "아산시", "서산시", "논산시", "금산군", "부여군", "서천군", "청양군", "홍성군", "예산군", "태안군", "계룡시", "당진시"];
                break;
            case '12' :
                sigunguArr = [];
                break;
            case '13' :
                sigunguArr = ["전주시", "군산시", "익산시", "정읍시", "남원시", "김제시", "완주군", "진안군", "무주군", "장수군", "임실군", "순창군", "고창군", "부안군"];
                break;
            case '14' :
                sigunguArr = ["목포시", "여수시", "순천시", "나주시", "광양시", "담양군", "곡성군", "구례군", "고흥군", "보성군", "화순군", "장흥군", "강진군", "해남군", "영암군", "무안군", "함평군", "영광군", "장성군", "완도군", "진도군", "신안군"];
                break;
            case '15' :
                sigunguArr = ["포항시", "경주시", "김천시", "안동시", "구미시", "영주시", "영천시", "상주시", "문경시", "경산시", "군위군", "의성군", "청송군", "영양군", "영덕군", "청도군", "고령군", "성주군", "칠곡군", "예천군", "봉화군", "울진군", "울릉군"];
                break;
            case '16' :
                sigunguArr = ["진주시", "통영시", "사천시", "김해시", "밀양시", "거제시", "양산시", "의령군", "함안군", "창녕군", "고성군", "남해군", "하동군", "산청군", "함양군", "거창군", "합천군", "창원시"];
                break;
            case '17' :
                sigunguArr = ["제주시", "서귀포시"];
                break;
