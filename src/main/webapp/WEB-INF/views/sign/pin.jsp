...
<div id="container">
    <!-- cont_area -->
    <div class="cont_area">
        <div class="txt_msg_box cont">계약자의 휴대폰번호 뒷 4자리를 입력하신 후 휴대폰PIN인증을 해주세요.</div>
        <div class="form_box sub">
            <dl class="list">
                <dt>휴대폰번호</dt>
                <dd>
                    <input type="text" class="input_ty" readonly="readonly" value="${user.CELL_NO_MASK }"/>
                </dd>
            </dl>
            <dl class="list">
                <dt>뒤 4자리</dt>
        ...
        <div class="btn_area">
            <a href="javascript:void(0);" onclick="fnOpen();" class="btn_m btn_ty02">휴대폰 PIN 인증</a>
        </div>
    </div>
    <!-- //cont_area -->
</div>
...
<form id="pinForm" name='f' action="/sign/authenticate" method='POST'>
    <input type='hidden' name='c' value='${user.CONTRC_NO}'>
    <input type='hidden' name='p' value="805316"/>
</form>
<div id="idPopup" class="ts_popup" style="display:none;">
    <div class="inner">
        <div id="wrap">
            <!-- header -->
            <header>
                ...
                <div class="cont_area">
                    ...
                    <div class="form_box sub">
                        <dl class="list">
                            <dt>휴대폰번호</dt>
                            <dd class="btn_t">
                                <input type="text" class="input_ty" id="hpNo" value="${user.CELL_NO_MASK}"
                                       readonly="readonly"/>
                        ...
                        <dl class="list">
                            <dt>인증번호입력</dt>
                            <dd>
                                <input type="number" id="idPinNo" class="input_ty" maxlength="6"
                                       style="ime-mode: disabled;" placeholder="숫자 6자리"
...
<script type="text/javascript">
    $(function () {
        $("#cellNoLast").keyup(function (event) {
            if (event.keyCode == 13) {
                fnOpen();
            }
        });
    ...
    // 휴대폰 PIN 인증 버튼 클릭 (팝업 열기)
    var fnOpen = function () {

        var paramMap = {
            cellNoLast: $("#cellNoLast").val(),
            CONTRC_NO: '${user.CONTRC_NO }'
        }
        ...
        ComUtil.request(requestMap, function (data) {
            ...
            if (data.result == "success") {
                ...
                $("#idPopup").show();
                fnReqPinNumber();
// 			$('#idPopup').tsPopup('open', '/sign/pin/pinPop');
