...
<div id="container">
	...
	<div class="cont_area">
		<div class="txt_msg_box cont">
			개인 신용정보 <span class="point">수집·이용·제공·취급·위탁</span>에<br>대해 동의해
			주세요.
		</div>
		<%--        <div class="progress">--%>
		...
		<div class="cont">
			<!-- form_box -->
			<form id="reportForm" method="post" action="/sign/pdf/view"
				onsubmit="return fnMoveNext()">
				<input type="hidden" name="contractNo" value="${user.contractNo}" />
				<input type="hidden" name="signCanvasDataUrl" id="signCanvasDataUrl"
					value="" /> <input type="submit" id="submitReportForm"
					class="hidden" />
						...
						<dd>
							<p>
								<input id="userNm" name="userNm" type="text" class="input_ty"
									value="${user.userNm}" autocomplete="off" readonly required>
							</p>
						</dd>
					</dl>
						...
						<dd>
							<p>
								<input type="email" name="email" value="${user.email}"
									class="input_ty" disabled required />
								<%--
