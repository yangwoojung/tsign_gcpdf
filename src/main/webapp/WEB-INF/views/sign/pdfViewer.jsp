...
<head>
    ...
    <!--#endif-->
    <script type='text/javascript' src="/resources/sign/pdfjs_test/build/pdf.js"></script>
    <script type='text/javascript' src="/resources/sign/pdfjs_test/build/pdf.worker.js"></script>
    <script type='text/javascript' src="/resources/sign/pdfjs_test/web/viewer.js"></script>
                    ...
                    <div id="toolbarViewerRight">
                        ...
                        <div id="editorModeButtons" class="splitToolbarButton toggled hidden" role="radiogroup">
                            <button id="editorFreeText" class="toolbarButton" disabled="disabled"
                                    title="Add FreeText Annotation" role="radio" aria-checked="false" tabindex="36"
                            ...
                            <button id="editorInk" class="toolbarButton" disabled="disabled" title="Add Ink Annotation"
                                    role="radio" aria-checked="false" tabindex="37" data-l10n-id="editor_ink">
