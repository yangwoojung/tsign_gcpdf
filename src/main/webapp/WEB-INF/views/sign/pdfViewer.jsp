    ...
    <script>
        $(function () {
            ...
            $('#create_pdf').click(function () {
                ...
                var mkpdfCount = 0;
                while (mkpdfCount < pdfPageCount) {
                    var pdfPageX = 0;//시점차이 발생으로 변수 선언 html2canvas 로딩이 오래걸려서 while 먼저 돌고 canvas가 나중에 생성됨
                    console.log("mkpdfCount==" + mkpdfCount);
                    html2canvas($('.page')[mkpdfCount]).then(function (canvas) {
                        console.log(canvas)
                        console.log("pdfPageX==" + pdfPageX);
                        var imgData = canvas.toDataURL('image/png'); //캔버스를 이미지로 변환
                        if (pdfPageX < pdfPageCount) {
...
// 					doc.addPage();
            ...
            $("#complete_pdf").on("click", function () {
            ...
            <div id="toolbarContainer">
                <div id="toolbarViewer">
                    <div id="toolbarViewerLeft">
                        ...
                        <!-- 양우정  -->
                        <button id="create_pdf">create_pdf</button>
                        <button id="complete_pdf">계약완료</button>
                        <button id="close_pdf">팝업닫기</button>
                    ...
                    <div id="toolbarViewerRight">
                        ...
                        <button id="secondaryToolbarToggle" class="toolbarButton" title="Tools" tabindex="36"
                                data-l10n-id="tools" style="display:none;">
				  ...
				  <select id="scaleSelect" title="Zoom" tabindex="23" data-l10n-id="zoom">
					...
					<option title="" value="1" selected="selected" data-l10n-id="page_scale_percent"
